    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(user != null){
            ...
            if("1".equals(remember)){
                //勾选了，发送Cookie
                //1. 创建Cookie对象
                //Set-Cookie: username=lulu; Max-Age=604800; Expires=Tue, 24-May-2022 04:50:41 GMT
                //Set-Cookie: password=123; Max-Age=604800; Expires=Tue, 24-May-2022 04:50:41 GMT
            ...
            response.sendRedirect(contextPath+"/backmain.jsp");
