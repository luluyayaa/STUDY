...
public class Book {
    ...
    public Book(Integer bkId, String bkName, String bkAuthor, String bkCountry, String bkType, Integer bkPrice, Integer bkStockNum, Date bkSellDate, String bkPicName, String bkStatus, String bkDesc) {
        this.bkId = bkId;
        this.bkName = bkName;
    ...
    public Date getBkSellDate() {
        return bkSellDate;
    }

    public void setBkSellDate(Date bkSellDate) {
        this.bkSellDate = bkSellDate;
    }
